"""paint final a base de comandos"""
...
class Paint:
    """Clase Paint para el programa paint donde se dibuja en este caso por comandos"""
    ...
    def dibujar_linea(self, x1, y1, x2, y2):
        """Función para dibujar una línea de los triángulos"""
        dx = abs(x2 - x1)
        dy = abs(y2 - y1)
